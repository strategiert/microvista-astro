...
Non-destructive testing also provides a more sustainable way to use raw materials, which is becoming increasingly important in today’s world. Because components are not changed in the process by non-destructive testing methods, the results of an inspection can be significantly more reliable. Common methods include visual inspection, radiography, industrial CT, eddy current and ultrasonic inspection. For instance, industrial computed tomography can be used to create three-dimensional models of components and assemblies by using reverse engineering [(reverse engineering of complex components with CT | Microvista)](/en/pruefaufgaben/reverse-engineerin/) to improve or develop new products.
